...
######################################################################################################################################################
    ...
    if distances.lower() == 'true':
        ...
        gp.addlocations_na("OD", "Destinations", r"in_memory\st", "Name Name #;CurbApproach # 0", "5000 Meters", "", "trline SHAPE;nd_Junctions NONE", "MATCH_TO_CLOSEST", "APPEND", "NO_SNAP", "5 Meters")
